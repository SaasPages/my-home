            ...
            {clientLogos.map((client, idx) => (
              ...
              >
                ...
                <div className="relative z-10 text-center">
                  <div className={`w-12 h-12 mx-auto mb-3 rounded-lg bg-gradient-to-br ${client.gradient} flex items-center justify-center text-white font-bold text-xl group-hover:scale-110 transition-transform duration-300`}>
